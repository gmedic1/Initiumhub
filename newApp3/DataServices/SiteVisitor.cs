...
namespace newApp3.DataServices
{
    public class SiteVisitor
    {
        ...
        public SiteVisitor(string hostName, string ip,  string countryCode, string countryName, string regionCode, string regionName, string city, string zipCode, string timeZone, string lat, string lon, string metroCode, string IPForward, string userAgent, string requestMethod, string serverMethod,
        ...
        public  void saveSiteVisitor()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand("spStoreVisitor", con))
                {
                    ...
                    cmd.Parameters.Add("@requestFromIp", SqlDbType.VarChar).Value = "";
                    ...
                    // await cmd.ExecuteNonQueryAsync();
                     cmd.ExecuteNonQueryAsync(); //changed to async to display the city faster
                    con.Close();
